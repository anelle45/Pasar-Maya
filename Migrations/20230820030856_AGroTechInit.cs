...
{
    /// <inheritdoc />
    public partial class AGroTechInit : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Message = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Likes = table.Column<int>(type: "int", nullable: false),
                    AnsweredById = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscussionAnswers_AspNetUsers_AnsweredById",
                        column: x => x.AnsweredById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscussionAnswers_Discussions_DiscussionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscussionImages", x => new { x.DiscussionId, x.ImageId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscussionImages_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationImages", x => new { x.NotificationId, x.ImageId });
                    table.ForeignKey(
                        name: "FK_NotificationImages_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommodityAreas", x => new { x.CommodityId, x.AreaId });
                    table.ForeignKey(
                        name: "FK_CommodityAreas_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommodityAreas_Commodities_CommodityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Predictions_Areas_AreaId",
                        column: x => x.AreaId,
                        principalTable: "Areas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "DiscussionAnswerImages",
                columns: table => new
                {
                    DiscussionAnswerId = table.Column<int>(type: "int", nullable: false),
                    ImageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscussionAnswerImages", x => new { x.DiscussionAnswerId, x.ImageId });
                    table.ForeignKey(
                        name: "FK_DiscussionAnswerImages_DiscussionAnswers_DiscussionAnswerId",
                        column: x => x.DiscussionAnswerId,
                        principalTable: "DiscussionAnswers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DiscussionAnswerImages_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PinnedDiscussionAnswers", x => new { x.DiscussionId, x.DiscussionAnswerId });
                    table.ForeignKey(
                        name: "FK_PinnedDiscussionAnswers_DiscussionAnswers_DiscussionAnswerId",
                        column: x => x.DiscussionAnswerId,
                        principalTable: "DiscussionAnswers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PinnedDiscussionAnswers_Discussions_DiscussionId",
                        column: x => x.DiscussionId,
                        principalTable: "Discussions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommodityAreas_AreaId",
                table: "CommodityAreas",
                column: "AreaId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionAnswerImages_ImageId",
                table: "DiscussionAnswerImages",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionAnswers_AnsweredById",
                table: "DiscussionAnswers",
                column: "AnsweredById");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionAnswers_DiscussionId",
                table: "DiscussionAnswers",
                column: "DiscussionId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscussionImages_ImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationImages_ImageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PinnedDiscussionAnswers_DiscussionAnswerId",
                table: "PinnedDiscussionAnswers",
                column: "DiscussionAnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_AreaId",
                table: "Predictions",
                column: "AreaId");
